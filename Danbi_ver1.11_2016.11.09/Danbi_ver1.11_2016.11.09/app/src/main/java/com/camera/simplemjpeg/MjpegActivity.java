...
import com.example.juhyang.project_danbi.R;
...
public class MjpegActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        * */
        ...
        ip_ad1 = Integer.parseInt(ipValues[0]);
        ip_ad2 = Integer.parseInt(ipValues[1]);
        ip_ad3 = Integer.parseInt(ipValues[2]);
        ip_ad4 = Integer.parseInt(ipValues[3]);
